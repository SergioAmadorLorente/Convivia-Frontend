...
import { PolicyHeader } from '../../components/ui';
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
      <View style={GLOBAL_STYLES.container}>
        <Text style={GLOBAL_STYLES.title}>Política de Privacidad</Text>
        ...
        <View style={{ width: '85%', marginTop: 20 }}>
          ...
          <PolicyHeader title="Información que Recopilamos" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Cómo Utilizamos Tu Información" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Cookies y Tecnologías Similares" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Seguridad de Datos" />
          ...
          <PolicyHeader title="Tus Derechos de Privacidad" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 24 }]}>
          ...
          <PolicyHeader title="Comprendiendo Nuestra Política de Cookies" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Cookies Esenciales" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Cookies de Rendimiento y Análisis" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Cookies de Preferencia y Funcionalidad" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Gestionando Tus Cookies" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 12 }]}>
          ...
          <PolicyHeader title="Cookies de Terceros" />
          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 24 }]}>
