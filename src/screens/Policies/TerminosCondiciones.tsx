    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
      <View style={GLOBAL_STYLES.container}>
        ...
        <View style={{ width: '85%', marginTop: 20 }}>
          ...
          <PolicyHeader title="Licencia de Uso" />
          ...
          <PolicyHeader title="Responsabilidades del Usuario" />
          ...
          <PolicyHeader title="Limitación de Responsabilidad" />
          ...
          <PolicyHeader title="Modificaciones a los Términos" />

          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 24 }]}>Convivia se reserva el derecho de modificar estos términos y condiciones en cualquier momento. Los cambios serán efectivos inmediatamente al publicarse en la plataforma. Tu uso continuado de la plataforma indica tu aceptación de dichas modificaciones.</Text>

          <PolicyHeader title="Contáctanos" />

          <Text style={[GLOBAL_STYLES.helperText, { marginBottom: 24 }]}>Si tienes preguntas o inquietudes sobre estos términos, por favor contáctanos a través de nuestros canales de soporte.</Text>
        </View>
      </View>
    </ScrollView>
  );
