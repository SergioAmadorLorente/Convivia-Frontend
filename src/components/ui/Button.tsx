...
const Button: React.FC<ButtonProps> = ({ onPress, onClick, disabled, loading, children, style, variant = 'primary' }) => {
  ...
  return (
    <TouchableOpacity style={buttonStyle} onPress={resolvedOnPress} disabled={disabled} activeOpacity={0.8}>
      {loading ? (
